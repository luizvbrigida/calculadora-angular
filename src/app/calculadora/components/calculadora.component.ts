...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Inicilaliza todos os operadores para os valores padrão.
   * 
   * @return void
   */
  ...
  /**
   * Adicionar o número selecionado para p cálculo posteriormente.
   * 
   * @param string numero 
   * @return void
  */
  ...
  definirOperacao(operacao: string): void {
    ...
    /* caso operação definida e número 2 selecioando, 
